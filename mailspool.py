...
class MailSpool:
    ...
    def store_messages(self, messages):
        ...
        for msg_data in messages:
            ...
            raw_email = str(parsed_email)
            
            # Store locally (if maildir_path is set)
            if self.maildir_path:
                self._store_local(filename, raw_email)
    ...
    def _store_local(self, filename, raw_email):
